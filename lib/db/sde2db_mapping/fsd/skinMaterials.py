...
class table_skins:
    def __init__(self):
        self.table_name = 'skin_materials'
        self.table_pk = 'skin_id'
        self.columns = []
        
        self.columns.append(col('skin_id',          'NUMBER', '#root'))
        self.columns.append(col('displayname_id',   'NUMBER', 'displayNameID'))
        self.columns.append(col('material_set_id',  'NUMBER', 'materialSetID'))
